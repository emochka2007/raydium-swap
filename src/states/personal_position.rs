...
use super::{POSITION_SEED, REWARD_NUM};
    ...
    pub fn update_rewards(
        ...
        for i in 0..REWARD_NUM {
            ...
            if add_delta {
                ...
                msg!(
                    "update personal reward, index:{}, owed_before:{:?}, amount_owed_delta:{}, owed_after:{}, reward_growth_delta:{}, self.liquidity:{}",
                    i,
                    curr_reward_info.reward_amount_owed,
                    amount_owed_delta,
                    self.reward_infos[i].reward_amount_owed,
                    reward_growth_delta,
                    self.liquidity
                );
            }
